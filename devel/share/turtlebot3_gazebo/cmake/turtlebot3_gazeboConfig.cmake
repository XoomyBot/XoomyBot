...
if("TRUE" STREQUAL "TRUE")
  set(turtlebot3_gazebo_SOURCE_PREFIX /home/gerda/catkin_ws/src/turtlebot3_simulations/turtlebot3_gazebo)
  set(turtlebot3_gazebo_DEVEL_PREFIX /home/gerda/catkin_ws/devel)
  ...
  set(turtlebot3_gazebo_INSTALL_PREFIX /home/gerda/catkin_ws/install)
...
if(NOT "/home/gerda/catkin_ws/src/turtlebot3_simulations/turtlebot3_gazebo/include " STREQUAL " ")
  set(turtlebot3_gazebo_INCLUDE_DIRS "")
  set(_include_dirs "/home/gerda/catkin_ws/src/turtlebot3_simulations/turtlebot3_gazebo/include")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'turtlebot3_gazebo' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/gerda/catkin_ws/src/turtlebot3_simulations/turtlebot3_gazebo/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/gerda/catkin_ws/devel/lib;/opt/ros/melodic/lib)
